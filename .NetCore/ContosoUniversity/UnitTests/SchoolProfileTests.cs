...
namespace UnitTests
{
    public class SchoolProfileTests
    {
        ...
        {
            Contoso.Angular.Settings.FilterGroup filterGroup = new Contoso.Angular.Settings.FilterGroup
            {
                Logic = "and",
                Filters = new List<Contoso.Angular.Settings.FilterDefinition>
                {
                    new Contoso.Angular.Settings.FilterDefinition{ Field = "FirstName", Operator = "contains", Value = "ja" },
                    new Contoso.Angular.Settings.FilterDefinition{ Field = "ZipCaode", Operator = "eq", Value = "28202" }
                }
            };
