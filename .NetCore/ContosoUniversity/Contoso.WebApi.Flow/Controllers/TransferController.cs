...
namespace Contoso.WebApi.Flow.Controllers
{
    ...
    public class TransferController : Controller
    {
        ...
        public async Task<IActionResult> PostVariableMetaData([FromBody]VariableMetaData value)
        {
            ...
            try
            {
                dynamic existing = await _rulesRepository.QueryAsync<VariableMetaDataModel, Contoso.Data.Automatic.VariableMetaData, object, object>
                (
                ...
                if (await this._rulesRepository.SaveAsync<VariableMetaDataModel, Contoso.Data.Automatic.VariableMetaData>(model))
                {
